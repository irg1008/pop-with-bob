...
func _process(_delta: float) -> void:
	if weapon_controller:
		weapon_controller.weapon_state_chart.set_expression_property("Weapon", weapon_controller.current_weapon.weapon_name)
		weapon_controller.weapon_state_chart.set_expression_property("Weapon ammo", weapon_controller.current_weapon_data.ammo)
